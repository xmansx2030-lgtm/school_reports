...
OPERATIONS_HETZNER_READ_TOKEN = (os.getenv("OPERATIONS_HETZNER_READ_TOKEN") or "").strip()
OPERATIONS_HETZNER_WRITE_TOKEN = (os.getenv("OPERATIONS_HETZNER_WRITE_TOKEN") or "").strip()
