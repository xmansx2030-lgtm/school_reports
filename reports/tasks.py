...
def _locked_generated_export_job(job_id: int):
    """Backward-compatible import path for the generated-export row lock."""
    from .services_generated_exports import locked_generated_export_job

    return locked_generated_export_job(job_id)
...
@shared_task(
    name=BUILD_GENERATED_EXPORT_TASK,
    bind=True,
    ignore_result=True,
    max_retries=0,
...
def build_generated_export_task(self, job_id: int) -> bool:
    """Run the generated-export service in the isolated media worker."""
    from .services_generated_exports import build_generated_export_job

    return build_generated_export_job(job_id)
