...
class PersonalPortfolioTests(TestCase):
    ...
    def test_school_axes_render_as_personal_workspace_without_approval(self):
        ...
        self.assertTemplateUsed(response, "reports/achievement_file.html")
    ...
    def test_notes_links_print_archive_and_data_export(self):
        ...
        printed = self.client.get(reverse("personal:portfolio_print") + "?year=" + self.YEAR)
        self.assertTemplateUsed(printed, "reports/pdf/achievement_file.html")
        self.assertContains(printed, 'class="page cover-page"')
        self.assertContains(printed, 'class="page page-break contents-page"')
        self.assertEqual(printed.content.count(b'class="criterion-count"'), 11)
    ...
    def test_successful_practice_stays_personal_across_portfolio_and_exports(self):
        ...
        initiatives = self.client.get(reverse("personal:initiatives"))
        self.assertTemplateUsed(initiatives, "reports/initiative_list.html")
        self.assertContains(initiatives, "ممارسة ناجحة")
        self.assertNotContains(initiatives, "إرسال للاعتماد")
